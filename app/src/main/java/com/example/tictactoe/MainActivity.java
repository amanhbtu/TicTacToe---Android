...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (bd != null) {
            Player1 = bd.get("Player1name").toString();
            Player2 = bd.get("Player2name").toString();
        } else {
            Player1 = "Player 1";
            Player2 = "Player 2";
        }
        ...
        for (int i = 0; i < 3; i++) {
            for (int j = 0; j < 3; j++) {
                ...
                buttons[i][j].setBackgroundColor(Color.parseColor("#00BCD4"));
    ...
    public void onBackPressed() {
        Intent intent = new Intent(this, LandPage.class);
    ...
    protected void onSaveInstanceState(Bundle outState) {
        ...
        outState.putString("Player1", Player1);
        outState.putString("Player2", Player2);
    }
